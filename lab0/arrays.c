...
int main(int argc, char* argv[]) {
  ...
  FourInts *fourIntsPtr = (FourInts*) malloc(sizeof(FourInts));
  fillArray((int*)fourIntsPtr, 4);
  assert(fourIntsPtr->a == 2);
  assert(fourIntsPtr->b == 5);
  assert(fourIntsPtr->c == 8);
  assert(fourIntsPtr->d == 11);
  free(fourIntsPtr);
  return 0;
}
